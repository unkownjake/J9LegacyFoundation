    ...
    <footer className="bg-accent py-6 mt-auto">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-stretch space-y-4 md:space-y-0 md:h-20">
          ...
          <div className="hidden md:block w-px self-stretch bg-accent-foreground/40 mx-4"></div>
          <div className="flex-1 flex items-center justify-center">
          ...
          <div className="flex-1 flex items-center justify-center">
            <Link
              to="/donate"
              className="bg-white text-accent flex items-center gap-2 px-6 py-2 rounded-lg font-semibold hover:bg-accent-lighter hover:text-accent-foreground transition duration-300"
            >
